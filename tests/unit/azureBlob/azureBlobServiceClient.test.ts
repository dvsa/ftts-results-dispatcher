...
describe('AzureBlobServiceClient', () => {
  test('GIVEN valid connectionString WHEN initate BlobServiceClient THEN proper instance is created', () => {
    mockedConfig.common.azureBlob.storageConnectionString = 'DefaultEndpointsProtocol=https;AccountName=cloud;AccountKey=x+y==;EndpointSuffix=core.windows.net';
  ...
  test('GIVEN invalid connectionString WHEN initate BlobServiceClient THEN AzureBlobError is thrown', () => {
    mockedConfig.common.azureBlob.storageConnectionString = 'DefaultEndpointsProtocol=https;AccountName=cloud;AccountKey=x+y==';
