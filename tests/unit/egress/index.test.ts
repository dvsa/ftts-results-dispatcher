...
describe('egress', () => {
  ...
  describe('ALLOWED_ADDRESSES', () => {
    each([
      [
        () => {
          mockedConfig.crm.azureAdUri = 'https://fttsshire.crm11.dynamics.com';
          mockedConfig.azureBlob.storageConnectionString = 'DefaultEndpointsProtocol=https;AccountName=dsuksdvtarsexpsftpfs005;AccountKey=stKxKyEc56Js/LoMmzOTOkZt7XMUzZpATzJQqPFRVBNlFJu+50fUQUDG9tL+VzqNZsn1XvCKqb1WPrSZgEHpng==;EndpointSuffix=core.windows.net';
          mockedConfig.azureFiles.storageConnectionString = 'DefaultEndpointsProtocol=https;AccountName=dsuksdvtarsexpsftpfs005;AccountKey=stKxKyEc56Js/LoMmzOTOkZt7XMUzZpATzJQqPFRVBNlFJu+50fUQUDG9tL+VzqNZsn1XvCKqb1WPrSZgEHpng==;EndpointSuffix=core.windows.net';
        },
        [
          {
